  ...
  <div className="main bg-black text-white">
    <div className="w-[50vw] flex flex-col items-center justify-center space-y-16 px-6 py-12">
      ...
      <div className="content-container space-y-16 text-gray-300">
        ...
        <section className="2d-transformations">
...
Sh = [ 1  shx  0 ]
     ...
     [ 0    0  1 ]
        ...
        <section className="3d-transformations">
...
Sh = [ 1  shxy  shxz  0 ]
     ...
     [  0    0    0   1 ]
        ...
        <section className="homogeneous-coordinates">
        ...
        <section className="transformation-matrices">
